...
alias pwvucontrol='GSK_RENDERER=gl pwvucontrol'
...
#POSH
export POSH_THEME=$'/home/camilo/.cache/oh-my-posh/themes/atomic.omp.json'
export POSH_SHELL='zsh'
export POSH_SHELL_VERSION=$ZSH_VERSION
export POSH_SESSION_ID=$'a383aca7-e0a4-4d55-a0db-b33306653f6e'
export POWERLINE_COMMAND='oh-my-posh'
export CONDA_PROMPT_MODIFIER=false
export ZLE_RPROMPT_INDENT=0
export OSTYPE=$OSTYPE

_omp_executable=$'/home/camilo/.local/bin/oh-my-posh'
