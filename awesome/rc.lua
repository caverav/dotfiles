...
globalkeys = my_table.join(
    ...
    -- super + shift + ...
    awful.key({ modkey, "Shift"   }, "l", function() awful.util.spawn( "arcolinux-logout" ) end,
    ...
    awful.key({ modkey1, altkey   }, "b", function() awful.util.spawn( browser1 ) end,
